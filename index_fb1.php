...
<body>
    ...
    <div class="overlay">
        <div class="send_fb">
             <h1>Post site on Facebook</h1>
            <form method="post" action="form-handler.php">

              <div>
               
                <label for="subject">Naar:</label>
              <input list="subject" name="browser" placeholder="Vrienden, groep of tijdlijn" size="30">
              <datalist id="subject">
                <option value="Vrienden">
                <option value="Groep">
                <option value="Tijdlijn">
                <option value="BID DT CMD">
              </datalist>
              </div>

              <div>
                <label for="message">Bericht: </label>
                <textarea id="message" name="message" placeholder="Schrijf je bericht hier." ></textarea>
              </div>
              <div>
                  <img src="images/Kiekn%20logo.png" width="100px" style="float: left; margin-right: 1em;"><p style="min-height: 3em; font-weight: bold;">Kiekn, de site om samen af te spreken voor een film of serie!</p>
              </div>
            </form>
              
              <div class="submit">
                <a href="fb_sent1.php"><input type="submit" value="Submit" id="submit" /></a>
                <a href="index1.php"><input type="submit" value="Cancel" id="cancel" /></a>
              </div>
        </div>
    </div>
		<div id="content">
