...
<main>
	<div id="content">
        ...
        <img src="images/jeannette.jpg" title="Jeannette" class="profielfoto">
            <h1 class="profielnaam">Jeannette Kuster</h1>
        <p>Hi, ik ben Jeannette en ik ben gek op series en films. Mijn favo serie op dit moment is Stranger Things. </br> Een echte aanrader.. </p>
        <fieldset id="genres">
            <legend><h2>Mijn genres</h2></legend>
            <ul>
                <li><img src="images/genre_20.png" class="genre"><h2>Comedy</h2></li>
                <li><img src="images/genre_03.png" class="genre"><h2>Romance</h2></li>
                <li><img src="images/genre_11.png" class="genre"><h2>Animatie</h2></li>
            </ul>
        </fieldset>
        <fieldset id="favofilms">
            ...
            <ul>
                <li><img src="images/Actie lijst_html_a693011f2ae0edff.gif" class="cover"><h2>Lucy<div class="vote"><span class="kiekn_vote kiekn_vote5">4,8</span><span class="vote-imdb"><img src="images/imdb.png" alt="IMDb-score"> 6.7 </span></div></h2></li>
                <li><img src="images/love.jpg" class="cover"><h2>Love<div class="vote"><span class="kiekn_vote kiekn_vote5">4,6</span><span class="vote-imdb"><img src="images/imdb.png" alt="IMDb-score"> 6.7 </span></div></h2></li>
        ...
        <fieldset id="favoseries">
            ...
            <ul>
                <li><img src="images/stranger_things.jpg" class="cover"><h2>Stranger Things<div class="vote"><span class="kiekn_vote kiekn_vote5">4,7</span><span class="vote-imdb"><img src="images/imdb.png" alt="IMDb-score"> 6.7 </span></div></h2></li>
                <li><img src="images/gossip-girl.jpg" class="cover"><h2>Gossip Girls<div class="vote"><span class="kiekn_vote kiekn_vote4">4,1</span><span class="vote-imdb"><img src="images/imdb.png" alt="IMDb-score"> 6.7 </span></div></h2></li>
                ...
                <li><img src="images/fuller-house.jpg" class="cover"><h2>Fuller House<div class="vote"><span class="kiekn_vote kiekn_vote3">2,9</span><span class="vote-imdb"><img src="images/imdb.png" alt="IMDb-score"> 6.7 </span></div></h2></li>
            </ul>
        </fieldset>
...
<footer>
  <ul>
    <li>&copy; 2017 D-E-E BID DT 2017</li>
    <li><a class="social" href="" title="Like ons op Facebook" alt="Like ons op Facebook"><span class="icon-facebook"></span></a> <a class="social" href="" title="Tweet over ons" alt="Tweet over ons"><span class="icon-twitter"></span></a></li>
    <li>HAN ICA 2017-18</li>
    <li>Ruitenberglaan 26<br />
      Arnhem</li>
  </ul>
</footer>
</body>
