            ...
            <div class="send">
                ...
                <form class="merlin">
                    ...
                    <fieldset>
                        ...
                        Ik wil jullie graag uitnodigen om de eerste aflevering van The Game of Thrones samen te kijken.
                    </fieldset>
                    <fieldset id="vrienden">
                        <legend><h2>Met wie:</h2></legend>
                        <label for="antony"><img src="images/antony.jpg" title="Antony"><span>Antony</span></label>
                        <label for="dennis"><img src="images/dennis.jpg" title="Dennis"><span>Dennis</span></label>
                    </fieldset>

                    <fieldset id="films">
                        <legend>
                            <h2>Welke serie en wanneer:</h2>
                        </legend>
                            <img src="https://cdn.myseries.tv/img/serie/banner/normal/401.jpg?1496396353" alt="Game of Thrones" /><a href="series3.html"> <h4>Game of Thrones<span class="kiekn_vote kiekn_vote5">4,9</span></h4></a>
                        <div class="timedetails">
                            Zaterdag 2 december om 20.00uur in Tivoli Utrecht.
                        </div>
                    </fieldset>
                </form>
                  <div class="submit">
                    <a href="series2.php"><input type="submit" value="Terug" id="submit" /></a>
                  </div>
            </div>
        </div>
        ...
        <div class="info">
          ...
          <div class="title"><h2>
            ...
            <fieldset>
                ...
                <textarea id="message" name="message" placeholder="Write your message here.">Ik wil jullie graag uitnodigen om een of mee afleveringen van de bovenstaande serie samen te kijken.</textarea>
            </fieldset>
            <br/>
