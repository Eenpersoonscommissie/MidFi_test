...
<main>
	<div id="content">
        ...
        <img src="images/christian.jpg" title="Christian" class="profielfoto">
            <h1 class="profielnaam">Christian Langelaar</h1>
        <p>Hoi, ik ben Christian, ben gek van bingen en kijk in het weekend gerust 8 uur achter elkaar! Als ik niet zou voetballen zou ik vastgroeien aan mijn sofa ;) </p>
        <fieldset id="genres">
        ...
        <fieldset id="vrienden">
            ...
            <a href="Profiel8.html" title="Profiel8" alt="Profiel8"><label for="rik"><img src="images/rik.jpg" title="rik"><span>Rik</span></label></a>
        </fieldset>
        <br/></div>
	</div>
  <aside>
