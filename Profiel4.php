...
<main>
	<div id="content">
        ...
        <img src="images/edson.jpg" title="Edson" class="profielfoto">
            <h1 class="profielnaam">Edson Lilipaly</h1>
        <p>Hoi, ik ben Edson, ben gek van bingen en kijk in het weekend gerust 8 uur achter elkaar! Als ik niet zou voetballen zou ik vastgroeien aan mijn sofa ;) </p>
        <fieldset id="genres">
