...
<main>
	<div id="content">
        ...
        <img src="images/erwin.jpg" title="Erwin" class="profielfoto">
            <h1 class="profielnaam">Erwin Sommers</h1>
        <p>Hoi, ik ben Erwin, ben gek van bingen en kijk in het weekend gerust 8 uur achter elkaar! Als ik niet zou voetballen zou ik vastgroeien aan mijn sofa ;) </p>
        <fieldset id="genres">
