        ...
        <form class="merlin">
            <fieldset id="films">
                ...
                <label for="4.5">21:00</label></dd>
					...
					<dl>
						<dt>vrijdag</dt>
						<dd><input type="radio" name="vrijdag" id="5.1">
                <label for="5.1">10:30</label></dd>
						<dd><input type="radio" name="vrijdag" id="5.2">
                <label for="5.2">13:15</label></dd>
						<dd><input type="radio" name="vrijdag" id="5.3">
                <label for="5.3">16:15</label></dd>
						<dd><input type="radio" name="vrijdag" id="5.4">
                <label for="5.4">19:00</label></dd>
						<dd><input type="radio" name="vrijdag" id="5.5">
                <label for="5.5">21:00</label></dd>
					</dl>
				</div>
            </fieldset>
            ...
            <fieldset>
                ...
                <input type="email" id="email" name="email" value="" placeholder="ander@e-mail.com, dinges@e-mail.com" size="80"/>
            </fieldset>
            <fieldset>
                <legend>
            ...
            <br/>
            <a href="merlin1_2.php"><input type="cancel" value="Stuur uitnodiging" id="submit" /></a>
        </form>
	</div>
  <aside>
