...
<main>
	<div id="content">
        <nav id="submenu">
            <a href="films1.php" class="active">Film Top 10</a>
    ...
    <ul>
      <li>
        <h4>
          <a href="film1.php">Alles voor elkaar</a> (2017)
        </h4>
      ...
      <li>
        <h4>
          <a href="film1.php">American Assassin</a> (2017)
        </h4>
      ...
      <li>
        <h4>
          <a href="film1.php">American Made</a> (2017)
        </h4>
      ...
      <li>
        <h4>
          <a href="film1.php">Barbie: Dolfijnenmagie</a> (2017)
        </h4>
      ...
      <li>
        <h4>
          <a href="film1.php">Brad&#39;s Status</a> (2017)
        </h4>
      ...
      <li>
        <h4>
          <a href="film1.php">De kleine vampier</a> (2017)
        </h4>
      ...
      <li>
        <h4>
          <a href="film1.php">Demain tout commence</a> (2016)
        </h4>
      ...
      <li>
        <h4>
          <a href="film1.php">Despicable Me 3</a> (2017)
        </h4>
        <div class="info">Animatie / avontuur van 
      ...
      <li>
        <h4>
          <a href="film1.php">Dikkertje Dap</a> (2017)
        </h4>
      ...
      <li>
        <h4>
          <a href="film1.php">Dummie de Mummie en de tombe van Achnetoet</a> (2017)
        </h4>
        <div class="info">Familie van 
      ...
      <li>
        <h4>
          <a href="film1.php">Flatliners</a> (2017)
        </h4>
      ...
      <li>
        <h4>
          <a href="film1.php">Geostorm</a> (2017)
        </h4>
      ...
      <li>
        <h4>
          <a href="film1.php">Girls Trip</a> (2017)
        </h4>
        <div class="info">Komedie van 
      ...
      <li>
        <h4>
          <a href="film1.php">Happy Death Day</a> (2017)
        </h4>
      ...
      <li>
        <h4>
          <a href="film1.php">HhhH - The Man with the Iron Heart</a> (2017)
        </h4>
      ...
      <li>
        <h4>
          <a href="film1.php">Home Again</a> (2017)
        </h4>
        <div class="info">Komedie / romantiek van 
      ...
      <li>
        <h4>
          <a href="film1.php">Jigsaw</a> (2017)
        </h4>
      ...
      <li>
        <h4>
          <a href="film1.php">Kapitein Onderbroek: Het eerste grote avontuur</a> (2017)
        </h4>
      ...
      <li>
        <h4>
          <a href="film1.php">Kingsman: The Golden Circle</a> (2017)
        </h4>
      ...
      <li>
        <h4>
          <a href="film1.php">Leatherface</a> (2017)
        </h4>
        <div class="info">Horror / thriller van 
      ...
      <li>
        <h4>
          <a href="film1.php">Misfit</a> (2017)
        </h4>
        <div class="info">Komedie van 
      ...
      <li>
        <h4>
          <a href="film1.php">My Little Pony: De Film</a> (2017)
        </h4>
      ...
      <li>
        <h4>
          <a href="film1.php">Sinterklaas &amp; het gouden hoefijzer</a> (2017)
        </h4>
        <div class="info">Familie van 
      ...
      <li>
        <h4>
          <a href="film1.php">Storm: Letters van Vuur</a> (2017)
        </h4>
      ...
      <li>
        <h4>
          <a href="film1.php">Stronger</a> (2017)
        </h4>
      ...
      <li>
        <h4>
          <a href="film1.php">The Dark Tower</a> (2017)
        </h4>
      ...
      <li>
        <h4>
          <a href="film1.php">The Emoji Movie</a> (2017)
        </h4>
      ...
      <li>
        <h4>
          <a href="film1.php">The Foreigner</a> (2017)
        </h4>
        <div class="info">Actie / thriller van 
      ...
      <li>
        <h4>
          <a href="film1.php">The LEGO Ninjago Movie</a> (2017)
        </h4>
        <div class="info">Animatie / actie van 
      ...
      <li>
        <h4>
          <a href="film1.php">The Mountain Between Us</a> (2017)
        </h4>
      ...
      <li>
        <h4>
          <a href="film1.php">Thor: Ragnarok</a> (2017)
        </h4>
        <div class="info">Actie / avontuur van 
      ...
      <li>
        <h4>
          <a href="film1.php">Weg van Jou</a> (2017)
        </h4>
