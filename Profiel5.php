...
<main>
	<div id="content">
        ...
        <img src="images/epco.jpg" title="Epco" class="profielfoto">
            <h1 class="profielnaam">Epco de Ruiter</h1>
        <p>Hoi, ik ben Epco, ben gek van bingen en kijk in het weekend gerust 8 uur achter elkaar! Als ik niet zou voetballen zou ik vastgroeien aan mijn sofa ;) </p>
        <fieldset id="genres">
