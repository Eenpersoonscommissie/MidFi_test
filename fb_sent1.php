    ...
    <div class="overlay">
        <div class="send_fb">
            ...
            <form method="post" action="form-handler.php">
              <div>
                  <img src="images/Kiekn%20logo.png" width="100px" style="float: left; margin-right: 1em;"><p style="min-height: 3em; font-weight: bold;">Je bericht is geplaatst op Facebook</p>
              </div>
            </form>
