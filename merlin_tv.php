...
<main>
	<div id="content">
        <h2>Samen Kiekn</h2>
        <p>Hier kan je anderen uitnodigen om samen een film of serie te gaan kijken. Je kan kiezen voor een film of serie op tv, op &eacute;&eacute;n van de streaming-kanalen of uiteraard in een bioscoop of filmhuis.</p>
        <p>Selecteer eerst de film(s) of serie(s), selecteer vervolgens welke vrienden je wil uitnodigen.</p>
        <form class="merlin">
            <fieldset>
                <legend>
                    <h2>Filmselectie</h2>
                ...
                <label for="BladeRunner">
                    <img src="images/HiFidelity2.jpg" class="cover"><h2>High Fidelity<div class="imdb_vote">3,75</div></h2>
