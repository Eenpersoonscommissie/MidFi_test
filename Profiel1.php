...
<main>
	<div id="content">
        ...
        <img src="images/antony.jpg" title="Anthony" class="profielfoto">
            <h1 class="profielnaam">Anthony Schraven</h1>
        <p>Hoi, ik ben Anthony, online ook bekend als Tony. Ik ben gek van motoren en kijk graag naar Marvel films!  </p>
        
        <fieldset id="genres">
            <legend><h2>Mijn genres</h2></legend>
            <ul>
                <li><img src="images/genre_19.png" class="genre"><h2>Sci-Fi</h2></li>
        ...
        <fieldset id="favofilms">
            ...
            <ul>
                <li><img src="images/Retour-en-Bougogne-6.jpg" class="cover"><h2>Wolverine<div class="vote"><span class="kiekn_vote kiekn_vote5">4,8</span><span class="vote-imdb"><img src="images/imdb.png" alt="IMDb-score"> 6.7 </span></div></h2></li>
                <li><img src="images/matterhorn-film.jpg" class="cover"><h2>Matterhorn<div class="vote"><span class="kiekn_vote kiekn_vote5">4,6</span><span class="vote-imdb"><img src="images/imdb.png" alt="IMDb-score"> 6.7 </span></div></h2></li>
                <li><img src="images/triller lijst_html_b888172c8f318d01.gif" class="cover"><h2>Escape<div class="vote"><span class="kiekn_vote kiekn_vote3">3,3</span><span class="vote-imdb"><img src="images/imdb.png" alt="IMDb-score"> 6.7 </span></div></h2></li>
